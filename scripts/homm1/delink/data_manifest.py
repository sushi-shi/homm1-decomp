"""homm1.delink.data_manifest - vostok's `--data-manifest` + section manifest.
...
def ehfuncinfo_rows(model: Model):
    ...
    from homm1.delink.pdb_synth import unit_names
...
def main(argv=None) -> int:
    ...
    ap = argparse.ArgumentParser(
        prog="python3 -m homm1.delink.data_manifest", description=__doc__,
