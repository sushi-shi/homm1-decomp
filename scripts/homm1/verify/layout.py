"""homm1.verify.layout - the FIELD-OFFSET oracle (i386/MSVC record layout).
...
whole harvest.
    ...
    python3 -m homm1.verify.layout [--unit U] [--var NAME] [--rebuild]
"""
...
def _harvest_unit(unit: str, source: str, flags: list[str] | None):
    ...
    from homm1.tool.clang import inc_cl

    args = (["--driver-mode=cl", "/DHOMM1_EMIT_META", *flags, *inc_cl()]
