"""homm1.audit.srcscan - the shared src/+include/ text-scan substrate.
...
specializations are catalogued by mangled name). HoMM1 includes its annotation
and domain headers in the scan.
"""
...
INCLUDE, SRC = REPO / "include", REPO / "src"

RVA_H = INCLUDE / "rva.h"
_SKIP = set()  # HoMM1 checks annotation/domain headers too.
...
def source_files(exts: tuple[str, ...] = (".h", ".hh", ".hpp", ".cpp", ".cc", ".cxx", ".inl")):
