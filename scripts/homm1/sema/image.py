"""homm1.sema.image - the retail image, scanned for address queries.

Three whole-image scans sit on top of homm1.core.pe, shared by every sema
...
Nothing here knows what a label MEANS - that is homm1.sema.index's job.
"""
...
from homm1.core.pe import Pe, image as _image
