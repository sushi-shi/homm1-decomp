"""homm1.sema.index - the Model, indexed for address queries.

sema reads identity from ONE place: `homm1.model.resolve()`. Every name,
...
from homm1.model import Binding, Model, resolve
