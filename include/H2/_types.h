...
struct tag_monsterInfo { short attributes; char padding[24]; };             // gMonsterDatabase[] (sizeof 26)
...
struct SWinSetup { unsigned char status; unsigned short port; char *value; }; // gWinSetup[] (7B, pack 1)
#pragma pack(pop)
