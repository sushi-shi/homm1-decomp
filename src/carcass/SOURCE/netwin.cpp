...
VA(0x00413ce8, 0x1b2)
H2_C_LINKAGE int __fastcall nb_init(int, int) { return 0; }
...
VA(0x0041411a, 0x104)
H2_C_LINKAGE int __fastcall nb_snd(int, int, int) { return 0; }
...
VA(0x0041421e, 0x4f6)
H2_C_LINKAGE int __cdecl nb_sess(void) { return 0; }
