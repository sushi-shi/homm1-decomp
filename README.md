...
**Overall (vs full engine): 35 / 985 functions exact (3.55%) &middot; 3.86% fuzzy &middot; 3.86% fuzzy max.**
...
_Started units alone: 35/419 fns exact, 6.53% fuzzy over 304,370 of 515,164 engine code bytes._

| Module        | Units | Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------: | ----: | --------: |
| `SOURCE`      |    23 |  5 / 354 (1.4%) |  5.2% |      5.2% |
| `BASE`        |    18 | 30 / 65 (46.2%) | 29.8% |     29.8% |
