...
**Overall (vs full engine): 44 / 985 functions exact (4.47%) &middot; 4.34% fuzzy &middot; 4.34% fuzzy max.**
...
_Started units alone: 44/421 fns exact, 7.35% fuzzy over 304,376 of 515,106 engine code bytes._

| Module        | Units | Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------: | ----: | --------: |
| `SOURCE`      |    23 |  5 / 354 (1.4%) |  5.2% |      5.2% |
| `BASE`        |    18 | 39 / 67 (58.2%) | 44.3% |     44.3% |
