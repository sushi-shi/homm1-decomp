...
**Overall (vs full engine): 42 / 985 functions exact (4.26%) &middot; 4.22% fuzzy &middot; 4.22% fuzzy max.**
...
_Started units alone: 42/419 fns exact, 7.15% fuzzy over 304,328 of 515,122 engine code bytes._

| Module        | Units | Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------: | ----: | --------: |
| `SOURCE`      |    23 |  5 / 354 (1.4%) |  5.2% |      5.2% |
| `BASE`        |    18 | 37 / 65 (56.9%) | 40.8% |     40.8% |
