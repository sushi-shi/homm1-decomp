...
**Overall (vs full engine): 19 / 985 functions exact (1.93%) &middot; 3.59% fuzzy &middot; 3.59% fuzzy max.**
...
_Started units alone: 19/409 fns exact, 6.10% fuzzy over 303,305 of 515,251 engine code bytes._

| Module        | Units | Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------: | ----: | --------: |
| `SOURCE`      |    23 |  5 / 354 (1.4%) |  5.2% |      5.2% |
| `BASE`        |    18 | 14 / 55 (25.5%) | 23.0% |     23.0% |
| `(unmatched)` |     — |  0 / 576 (0.0%) |  0.0% |      0.0% |
