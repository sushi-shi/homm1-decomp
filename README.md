...
**Overall (vs full engine): 18 / 985 functions exact (1.83%) &middot; 3.58% fuzzy &middot; 3.58% fuzzy max.**
...
_Started units alone: 18/409 fns exact, 6.08% fuzzy over 303,305 of 515,251 engine code bytes._

| Module        | Units | Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------: | ----: | --------: |
| `SOURCE`      |    23 |  4 / 354 (1.1%) |  5.1% |      5.1% |
