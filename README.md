...
**Overall (vs full engine): 21 / 985 functions exact (2.13%) &middot; 3.60% fuzzy &middot; 3.60% fuzzy max.**
...
_Started units alone: 21/409 fns exact, 6.11% fuzzy over 303,298 of 515,244 engine code bytes._

| Module        | Units | Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------: | ----: | --------: |
| `SOURCE`      |    23 |  5 / 354 (1.4%) |  5.2% |      5.2% |
| `BASE`        |    18 | 16 / 55 (29.1%) | 23.3% |     23.3% |
