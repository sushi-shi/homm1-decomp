...
**Overall (vs full engine): 79 / 985 functions exact (8.02%) &middot; 5.80% fuzzy &middot; 5.80% fuzzy max.**
...
_Started units alone: 79/433 fns exact, 9.80% fuzzy over 304,788 of 514,982 engine code bytes._

| Module        | Units |  Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | -----: | --------: |
| `SOURCE`      |    23 |   5 / 354 (1.4%) |   5.2% |      5.2% |
| `BASE`        |    20 |  62 / 67 (92.5%) |  81.0% |     81.0% |
| `lzhuf`       |     7 | 12 / 12 (100.0%) | 100.0% |    100.0% |
