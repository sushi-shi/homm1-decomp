...
**Overall (vs full engine): 31 / 985 functions exact (3.15%) &middot; 3.76% fuzzy &middot; 3.76% fuzzy max.**
...
_Started units alone: 31/415 fns exact, 6.37% fuzzy over 303,850 of 515,172 engine code bytes._

| Module        | Units | Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------: | ----: | --------: |
| `SOURCE`      |    23 |  5 / 354 (1.4%) |  5.2% |      5.2% |
| `BASE`        |    18 | 26 / 61 (42.6%) | 27.5% |     27.5% |
| `(unmatched)` |     — |  0 / 570 (0.0%) |  0.0% |      0.0% |
