...
**Status: validated matching pilot; campaign tooling repair in progress.**
The remaining requirements and their validation evidence are tracked in
[the tooling repair checklist](docs/tooling-repair.md).
Use `homm1 reference NAME_OR_RVA` to inspect pinned Buka 2.1 source
correspondences, confidence and known differences. These are navigation evidence,
separate from HoMM1 matching claims.

<!-- homm1:campaign:start -->
<!-- Generated by homm1 build; edit tooling, not this block. -->
**Measured campaign: 3/3 functions exact; 290/290 claimed code bytes in exact functions.**

| Unit | Exact functions | Claimed bytes | CUR | MAX | HIST |
| --- | ---: | ---: | ---: | ---: | ---: |
| app_about | 1/1 | 144 | 100.00% | 100.00% | 100.00% |
...
These figures are not whole-game coverage. Data matching remains deferred.
<!-- homm1:campaign:end -->
