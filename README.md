...
**Status: direct Gruntz matching pipeline operational.** AppAbout, PollSound
and ForcePollSound match **290/290 claimed code bytes**. The copied graph covers
VC4 compilation, claims, model resolution, synthetic-PDB delinking, objdiff,
score banking, cleanliness gates, README refresh and opt-in candidate linking.
Data matching is deferred; this is not whole-game coverage or a linked game.
...
**Overall (vs full engine): 3 / 1,250 functions exact (0.24%) &middot; 0.05% fuzzy &middot; 0.05% fuzzy max.**
...
_Started units alone: 3/3 fns exact, 100.00% fuzzy over 290 of 565,408 engine code bytes._

| Module        | Units |  Functions exact |  Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | -----: | --------: |
| `SOURCE`      |     2 |   3 / 3 (100.0%) | 100.0% |    100.0% |
| `(unmatched)` |     — | 0 / 1,247 (0.0%) |   0.0% |      0.0% |
