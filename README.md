...
**Overall (vs full engine): 39 / 985 functions exact (3.96%) &middot; 3.96% fuzzy &middot; 3.96% fuzzy max.**
...
_Started units alone: 39/419 fns exact, 6.71% fuzzy over 304,341 of 515,135 engine code bytes._

| Module        | Units | Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------: | ----: | --------: |
| `SOURCE`      |    23 |  5 / 354 (1.4%) |  5.2% |      5.2% |
| `BASE`        |    18 | 34 / 65 (52.3%) | 32.9% |     32.9% |
