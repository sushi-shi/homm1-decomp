...
**Status: direct Gruntz matching pipeline operational.** The source tree labels
**386 of 1,250 functions** in 31 inferred donor TUs. Of those, 383 empty bodies
are strict HoMM2 Buka 2.1 and PoL 2.0 agreements; `AppAbout`, `PollSound`, and
`ForcePollSound` remain byte-exact. Buka 2.1 supplies preferred names and TU
order, while PoL 2.0 independently confirms identity and supplies VC4-compatible
declarations. Data matching remains deferred.
...
**Overall (vs full engine): 41 / 985 functions exact (4.16%) &middot; 4.20% fuzzy &middot; 4.20% fuzzy max.**
...
_Started units alone: 41/419 fns exact, 7.10% fuzzy over 304,328 of 515,122 engine code bytes._

| Module        | Units | Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------: | ----: | --------: |
| `SOURCE`      |    23 |  5 / 354 (1.4%) |  5.2% |      5.2% |
| `BASE`        |    18 | 36 / 65 (55.4%) | 40.1% |     40.1% |
| `(unmatched)` |     — |  0 / 566 (0.0%) |  0.0% |      0.0% |
