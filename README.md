...
**Overall (vs full engine): 32 / 985 functions exact (3.25%) &middot; 3.78% fuzzy &middot; 3.78% fuzzy max.**
...
_Started units alone: 32/416 fns exact, 6.40% fuzzy over 303,945 of 515,171 engine code bytes._

| Module        | Units | Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------: | ----: | --------: |
| `SOURCE`      |    23 |  5 / 354 (1.4%) |  5.2% |      5.2% |
| `BASE`        |    18 | 27 / 62 (43.5%) | 28.0% |     28.0% |
| `(unmatched)` |     — |  0 / 569 (0.0%) |  0.0% |      0.0% |
