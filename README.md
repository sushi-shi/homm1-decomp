...
**Overall (vs full engine): 7 / 985 functions exact (0.71%) &middot; 1.52% fuzzy &middot; 1.52% fuzzy max.**
...
_Started units alone: 7/187 fns exact, 7.79% fuzzy over 100,824 of 515,266 engine code bytes._

| Module        | Units | Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------: | ----: | --------: |
| `SOURCE`      |    23 |  3 / 142 (2.1%) |  6.7% |      6.7% |
| `BASE`        |    10 |   4 / 45 (8.9%) | 14.6% |     14.6% |
| `(unmatched)` |     — |  0 / 586 (0.0%) |  0.0% |      0.0% |
