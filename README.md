...
**Overall (vs full engine): 17 / 985 functions exact (1.73%) &middot; 3.58% fuzzy &middot; 3.58% fuzzy max.**
...
_Started units alone: 17/409 fns exact, 6.08% fuzzy over 303,305 of 515,251 engine code bytes._

| Module        | Units | Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------: | ----: | --------: |
| `SOURCE`      |    23 |  3 / 354 (0.8%) |  5.1% |      5.1% |
