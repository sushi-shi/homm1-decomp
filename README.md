...
**Overall (vs full engine): 3 / 1,250 functions exact (0.24%) &middot; 2.21% fuzzy &middot; 2.21% fuzzy max.**
...
_Started units alone: 3/312 fns exact, 5.27% fuzzy over 237,599 of 565,408 engine code bytes._

| Module        | Units | Functions exact | Fuzzy | Fuzzy Max |
| :------------ | ----: | --------------: | ----: | --------: |
| `SOURCE`      |    23 |  3 / 280 (1.1%) |  5.0% |      5.0% |
| `BASE`        |     8 |   0 / 32 (0.0%) | 11.6% |     11.6% |
| `(unmatched)` |     — |  0 / 864 (0.0%) |  0.0% |      0.0% |
