...
from homm1.symbols import source_symbols as mod
from homm1.symbols.annotated_data import AnnotatedDataDefinition
from homm1.symbols.source_symbols import (
    SourceSymbol,
    collect,
...
class CompgenMarkerTests(unittest.TestCase):
    def test_marker_uses_semantic_role_instead_of_volatile_coff_counter(self):
        ...
        self.assertEqual(
            rows[0].name,
            "__h1cg$SOURCE$PHILAI$static_ctor$SVSearchArray")
    ...
    def test_qualified_static_owner_has_a_stable_semantic_name(self):
        ...
        self.assertEqual(
            rows[0].name,
            "__h1cg$BASE$AudiereMusic$static_init_dispatch$"
            "AudiereMusicState$stream")
...
class CollectTests(unittest.TestCase):
    ...
    def test_compgen_data_gets_a_stable_pdb_identity(self):
        ...
        self.assertEqual(
            out[0].name,
            "__h1cg$SOURCE$KB$data$gWinSetupBuildImprovement0")
